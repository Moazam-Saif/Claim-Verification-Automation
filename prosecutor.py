...
- An invoice date that is AFTER the treatment date is normal and expected. Do not flag this.
- Only flag invoice_date if it is BEFORE the treatment date (pre-treatment billing fraud pattern)
